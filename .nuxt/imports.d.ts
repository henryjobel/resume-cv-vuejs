...
export { animationFunction } from '../utils/animationFunction';
export { defaultData, musician, writer, lawyer, fitnessTrainer, designer, programmer, blogs } from '../utils/data';
export { navFunction } from '../utils/navFunction';
export { createSkillsDot, dotResize, titleActive, activeSectionWithScroll, aTag } from '../utils/utils';
